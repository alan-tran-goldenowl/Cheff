...
import {
  formatDateTime, getDay, getHour, getMinute, getMonth, getYear, setDate, setTime,
} from 'utils/date'
...
const DatePicker = ({
  date = '', onPressDate, onPressTime, onSelectDate,
}) => {
  ...
  return (
    <>
      ...
      <View style={styles.row}>
        <TouchableOpacity onPress={handlePressDate} style={[styles.pickerDate, styles.left]}>
          <Icon name="calendar" size={30} color={COLOR.WHITE_COLOR} />
          <View>
            <Text style={[styles.pickerTitle, styles.leftContent]}>Chọn ngày</Text>
            <Text style={[styles.pickerValue, styles.leftContent]}>{formatDateTime(date, DATE_FORMAT_TOKEN)}</Text>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={handlePressTime} style={styles.picker}>
          ...
          <View>
            ...
            <Text style={styles.pickerValue}>{formatDateTime(date, TIME_FORMAT_TOKEN)}</Text>
          </View>
        </TouchableOpacity>
      </View>
      <DateTimePicker
